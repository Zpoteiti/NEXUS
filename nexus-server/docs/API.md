...
Create a device token for connecting a nexus-client.
...
// Response 200
{ "token": "nexus_dev_a1b2c3...", "device_name": "my-laptop" }
```
...
// Response 200
[
  { "token": "nexus_dev_...", "device_name": "my-laptop", "created_at": "2025-01-01T00:00:00Z" }
]
```
...
```json
// Request
{ "soul": "You are NEXUS, a distributed AI agent..." }
